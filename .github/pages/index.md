...
<section class="truth-panel">
  <div>
    ...
    <p>Start with the <a href="spec.html">shipped contract</a>, trace decisions in the <a href="docs/adrs/">ADR index</a>, or inspect current delivery status in the <a href="plan.html">architecture plan</a>.</p>
  </div>
  <aside>
