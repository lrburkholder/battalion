...
<section class="truth-panel">
  <div>
    ...
    <p>Start with the <a href="spec.html">shipped contract</a>, trace decisions in the <a href="docs/adrs/">ADR index</a>, or inspect current delivery status in <a href="docs/status.html">project status</a> and the <a href="backlog.json">canonical backlog</a>.</p>
  </div>
  <aside>
