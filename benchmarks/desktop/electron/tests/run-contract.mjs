...
import { runScenario } from "../src/adapter.mjs";

const here = dirname(fileURLToPath(import.meta.url));
const root = join(here, "..");
const input = process.argv[2] ? resolve(process.argv[2]) : join(root, "benchmark-input");
...
console.log(`PASS: Electron adapter completed ${trace.entries.length} shared steps`);
